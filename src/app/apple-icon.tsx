...
export default function AppleIcon() {
  return new ImageResponse(
    (
      ...
      >
        <svg width="156" height="156" viewBox="0 0 100 100">
          ...
          <path
            d="M78,30 L80.5,36 L86.5,38.5 L80.5,41 L78,47 L75.5,41 L69.5,38.5 L75.5,36 Z"
            fill="#fff6e0"
          />
          <path
            d="M24,80 L25.8,84.2 L30,86 L25.8,87.8 L24,92 L22.2,87.8 L18,86 L22.2,84.2 Z"
            fill="#fff6e0"
          />
        </svg>
      </div>
